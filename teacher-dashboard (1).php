...
// Next upcoming class for Widget A
$nextClass = null;
try {
...
// Pending critique cards for Widget C
$assignments = [];
try {
    $stmt2 = DB::conn()->prepare("
        SELECT a.assignment_id, a.title, a.diff_score,
               a.ref_label, a.sub_label, a.ref_image, a.sub_image,
        ...
        LIMIT  8
    ");
    $stmt2->execute([$teacher['teacher_id']]);
    $assignments = $stmt2->fetchAll();
} catch (PDOException $e) {
    $assignments = [];
}

function diffClass($d) { return $d >= 30 ? 'high' : ($d >= 15 ? 'medium' : 'low'); }
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="content-wrapper" id="contentWrapper">
    <main class="dashboard-container">
        ...
        <div class="widget widget-next-class">
            ...
            <div class="class-details">
                <h3 class="class-title" id="widgetClassTitle">
                    <?php echo $nextClass ? htmlspecialchars($nextClass['name']) : 'No upcoming classes'; ?>
                </h3>
        ...
        <div class="widget widget-heatmap">
            ...
            <div class="heatmap-grid">
                <div class="heatmap-cell good" data-metric="focus"
                     data-tip="Focus: ratio of submitted vs expected work this week.">
                ...
                <div class="heatmap-cell bad" data-metric="friction"
                     data-tip="Tech friction: average AI deviation score.">
                    <div class="heatmap-cell-icon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="heatmap-cell good" data-metric="pulse"
                     data-tip="Overall pulse: active student ratio across all classes.">
                    <div class="heatmap-cell-icon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Widget C: Priority Review Queue (live from DB) -->
            ...
            <div class="critique-queue">
                ...
                <?php else: ?>
                    <?php foreach ($assignments as $a):
                        ...
                        $refImg = !empty($a['ref_image'])
                            ? htmlspecialchars($a['ref_image'])
                            : 'assests/mudra-practice-1.jpeg';
                        $subImg = !empty($a['sub_image'])
                            ? htmlspecialchars($a['sub_image'])
                            : 'assests/mudra-practice-2.jpeg';
                    ?>
        ...
        <!-- Widget D: Today's Schedule (rebuilt by script.js from api/classes.php) -->
